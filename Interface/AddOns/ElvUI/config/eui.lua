...
P['unitframe'].units.player.power.height = 6
P['unitframe'].units.target.power.height = 6
P['unitframe'].units.focus.power.height = 6
P['unitframe'].units.focustarget.power.height = 4
P['unitframe'].units.targettarget.power.height = 4
P['unitframe'].units.targettargettarget.power.height = 4
P['unitframe'].units.pet.power.height = 4
P['unitframe'].units.pettarget.power.height = 4
P['unitframe'].units.boss.power.height = 4
P['unitframe'].units.arena.power.height = 4
P['unitframe'].units.party.power.height = 4
P['unitframe'].units.raid.power.height = 4
