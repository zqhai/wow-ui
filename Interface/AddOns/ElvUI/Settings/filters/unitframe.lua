...
G.unitframe.aurafilters['Whitelist'] = {
	...
	['spells'] = {
		...
		[116849] = Defaults(), --Life Cocoon
		[22812] = Defaults(), --Barkskin
		[116631] = Defaults(), --·ç±©Ö®¶Ü(FM)
		[138242] = Defaults(), --ÈÙÒ«Ö®¶Ü(T15)	
		[137590] = Defaults(), --³ÈÉ«¶à²Ê(ÉöÉÏÏÙËØ-¼±ËÙ+30%)
		[137593] = Defaults(), --³ÈÉ«¶à²Ê(¸ÕÒã-¼õÉË+20%)
		[137596] = Defaults(), --³ÈÉ«¶à²Ê(µçºÉ)
		[137288] = Defaults(), --³ÈÉ«¶à²Ê(½ÚÄÜÊ©·¨,5.3¸ÄÃû½Ð'ÇåÐÑ')
		[136431] = Defaults(), --¹ê¿ÇÕðµ´(DEBUFF)
		[142535] = Defaults(), -- Õ÷·þÖ®»ê
		[142530] = Defaults(), -- ÑªÐÈÎè¸Ö		
		[173322] = Defaults(), --Ñª»·Ö®Ó¡
		[159234] = Defaults(), --À×ÉñÖ®Ó¡
		[159673] = Defaults(), --Ó°ÔÂÖ®Ó¡
		[159674] = Defaults(), --ºÚÊ¯Ö®Ó¡
		[159675] = Defaults(), --Õ½¸èÖ®Ó¡
		[159676] = Defaults(), --ËªÀÇÖ®Ó¡
