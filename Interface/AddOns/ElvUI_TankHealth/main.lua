...
elseif GetLocale() == 'zhTW' then
	...
	LL["Toggle expanding the potential amount healed past max health."] = "Toggle expanding the potential amount healed past max health."
end
    ...
    E.Options.args.TankHealth = {
        ...
        args = {
            color = {
                ...
                type = "color",
                hasAlpha = true,
                name = LL["Healbar color"],
                desc = LL["Change the color of the potential self-heal on the healthbar."],
                get = function(info)
            ...
            overheal = {
                order = 2,
                type = "toggle",
                name = LL["Show overheal"],
                desc = LL["Toggle expanding the potential amount healed past max health."],
                get = function(info)
