...
.."<br/><br/>"
.."有些人会在扫描时从WoW断线，你可以在以下网址读取相关原因及可能的解决办法:"
.."<br/>"
...
AtrL["%d stacks available"] = "%d 堆栈可购买"
AtrL["+"] = "进阶搜寻"
AtrL["1 stack available"] = "1 堆栈可购买"
...
AtrL["All Items"] = "全部物品"
AtrL["always"] = "总是"
AtrL["Are you sure you want to create\nan auction with no buyout price?"] = "确定不设直购价?"
...
AtrL["Auctionator scan data"] = "Auctionator 扫描数据"
AtrL["Auctionator"] = ""
...
AtrL["based on cheapest stack of the same size"] = "根据目前同堆栈数最低价"
...
AtrL["BOP"] = "拾取榜定"
AtrL["Buy Another"] = "再购入一项"
AtrL["Buy One"] = "购入一项"
AtrL["Buy"] = "购入"
AtrL["Buyout Price"] = "直购价"
...
AtrL["Epic"] = "史诗"
AtrL["Flasks"] = "精炼药剂"
AtrL["For information on the latest version browse to"] = "取得最新版本信息:"
AtrL["for your stack of %d"] = "总价 (堆栈数%d)"
...
AtrL["Herbs"] = "草药"
AtrL["History"] = "纪录"
AtrL["If this option is checked, every time you initiate a new auction the auction duration will be reset to the default duration you've selected."]="若勾选此选项，每当你摆放拍卖物品时，将自动设定有效期限被默认值"
...
AtrL["max"] = "最多"
AtrL["max. stacks of %d"] = "最多个，堆栈 %d"
AtrL["Minimum Quality Level"] = "最低物品质量"
AtrL["Minimum quality level:"] = "最低物品质量"
AtrL["More"] = "其他"
...
AtrL["pricing history cleared"] = "价格纪录已清除"
AtrL["Processing"] = "处理中"
...
AtrL["Recommended buyout price"] = "建议直购价"
AtrL["Recommended Buyout Price"] = "建议直购价"
...
AtrL["Sell"] = "卖出"
AtrL["Selling"] = "卖出"
AtrL["Set a default duration"]="设定有效期限默认值"
...
AtrL["stack available"] = "堆栈可购买"
AtrL["stack for"] = "堆栈的"
AtrL["stack of"] = "项，堆栈"
AtrL["stack price"] = "堆栈总价"
AtrL["Stack Price"] = "总价"
AtrL["stack"] = "堆栈"
AtrL["stacks available"] = "堆栈可购买"
AtrL["stacks for"] = "堆栈的"
AtrL["stacks for:"] = "堆栈的:"
AtrL["stacks of"] = "项，堆栈"
